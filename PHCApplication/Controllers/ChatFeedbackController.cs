...
namespace PHCApplication.Controllers
{
    public class ChatFeedbackController : Controller
    {
        ...
        public ChatFeedbackController(PHCApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ChatFeedbackId,Date,Feedback,Rating,WaitTimeInMinute,TreatmentEffectivene,CommunicationClarit,EaseOfAppointmen,SatisfactionWithExperience,UserID")] ChatFeedback chatfeedback)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ChatFeedbackId,Date,Feedback,Rating,WaitTimeInMinute,TreatmentEffectivene,CommunicationClarit,EaseOfAppointmen,SatisfactionWithExperience,UserID")] ChatFeedback chatfeedback)
        {
