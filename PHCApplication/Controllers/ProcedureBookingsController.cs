...
{
    public class ProcedureBookingsController : Controller
    {
        private readonly PHCApplicationDbContext _context;

        public ProcedureBookingsController(PHCApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BookingsId,BookingDate,StartDateTime,EndDateTime,ServiceType,Status,Notes,DurationInMinutes,AdditionalDetails,TermsAndCondition,UserID")] Bookings bookings)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookingsId,BookingDate,StartDateTime,EndDateTime,ServiceType,Status,Notes,DurationInMinutes,AdditionalDetails,TermsAndCondition,UserID")] Bookings bookings)
        {
