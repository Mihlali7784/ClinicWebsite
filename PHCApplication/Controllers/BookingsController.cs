...
namespace PHCApplication.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public BookingsController(PHCApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BookingsId,BookingDate,StartDateTime,EndDateTime,ServiceType,Status,Notes,UserID")] Bookings bookings)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookingsId,BookingDate,StartDateTime,EndDateTime,ServiceType,Status,Notes,UserID")] Bookings bookings)
        {
